...
void picInverter(Image invert); // Inverts the colours in every pixel.
...
void picRotation(Image *resize); // This function is turning the picture 90-degrees.

void picZoom(Image *zoom); // This function is used when zooming.
...
void picEnlarger(Image *resize); // This is my function to enlarge pictures.
